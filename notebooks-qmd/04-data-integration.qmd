...
- I join the two databases provided by *NPN* and to this information I add the *fixed* data that was obtained for each coordinate. The final database has 4101 rows (a total of 152 different coordinates) and 43 columns.
